...
<body>
    ...
    <div class="error-container">
        ...
        <p class="error-message">Oops! You don't have permission to access this page.</p>
        <p class="error-suggestion">It seems like you've tried to access a restricted area. Please try the following:</p>
