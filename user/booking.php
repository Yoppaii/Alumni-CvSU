        ...
        <div class="book-content">
           ...
           <div id="book-step4" class="book-step-content" style="display: none;">
               <div class="book-summary">
                   <h2 style="margin-top: 0; color: #111827;">Booking Summary</h2>
                   <div class="book-summary-item">
                       <span class="book-summary-label">Selected Room:</span>
                       <span class="book-summary-value" id="book-summary-room">-</span>
                   </div>
                   <div class="book-summary-item">
                       <span class="book-summary-label">Number of Guests:</span>
                       <span class="book-summary-value" id="book-summary-guests">-</span>
                   </div>
                   <div class="book-summary-item">
                       <span class="book-summary-label">Check-in:</span>
                       <span class="book-summary-value" id="book-summary-checkin">-</span>
                   </div>
                   <div class="book-summary-item">
                       <span class="book-summary-label">Check-out:</span>
                       <span class="book-summary-value" id="book-summary-checkout">-</span>
                   </div>
                   <div class="book-summary-item">
                       <span class="book-summary-label">Duration:</span>
                       <span class="book-summary-value" id="book-summary-duration">-</span>
                   </div>
                   <div class="book-summary-item">
                       <span class="book-summary-label">Price per Night:</span>
                       <span class="book-summary-value" id="book-summary-price">-</span>
                   </div>
                   <div class="book-summary-item" style="margin-top: 10px; padding-top: 10px; border-top: 2px solid #e5e7eb;">
                       <span class="book-summary-label" style="font-size: 1.1em;">Total Price:</span>
                       <span class="book-summary-value" id="book-summary-total-price" style="font-size: 1.1em; color: var(--primary-color);">-</span>
                   </div>
               </div>
           </div>
                ...
                window.arrivalCalendar = flatpickr("#book-arrival-datetime", {
                        ...
                        if (selectedDates.length > 0) {
                            ...
                            if (dateBooking) {
                                ...
                                if (selectedDate < availableTime) {
                                    ...
                                    NotificationSystem.show(`This room will be available after ${formattedTime} (2 hours needed for cleaning)`, 'error');
                            ...
                            if (window.departureCalendar) {
                                window.departureCalendar.set('minDate', selectedDate);
                                if (bookingData.departure && bookingData.departure <= selectedDate) {
                    ...
                    onDayCreate: function(dObj, dStr, fp, dayElem) {
                        ...
                        if (dateBooking) {
                            ...
                            dayElem.title = "Room available after cleaning";
                        } else if (bookedDates.includes(dateStr)) {
