...
document.getElementById("printReportTracer").addEventListener("click", async function () {
    ...
    doc.text("Bahay ng Alumni - Alumni Tracer Report", margin + 35, y + 15, { baseline: 'middle' });
    ...
    const filters = [
        ...
        { label: "From Year", value: fromYear || "All Year" },
        { label: "To Year", value: toYear || "All Year" },
        { label: "Employment Status", value: employmentStatus || "All Status" },
    ];
