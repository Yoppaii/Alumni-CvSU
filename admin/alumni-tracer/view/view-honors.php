...
$query = "SELECT honors_or_awards, COUNT(*) as count 
          ...
          WHERE honors_or_awards IS NOT NULL 
...
<div class="education-background-distribution-analytics">
    <div class="analytics-header">
        ...
        <h2 class="analytics-title">Honors or Awards Distribution Analysis</h2>
    </div>
    ...
    <div class="analytics-content">
        <div class="analytics-chart-container">
            <canvas id="honorsOrAwardsDistribution"></canvas>
        </div>
...
<style>
    /* Keep the same styles as you have for your charts and stats */
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function createChart(type) {
            const ctx = document.getElementById('honorsOrAwardsDistribution').getContext('2d');
            ...
            const config = {
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        title: {
                            display: true,
                            text: 'Distribution by Honors or Awards',
                            font: {
                                size: 18
                            },
                            color: getComputedStyle(document.documentElement).getPropertyValue('--text-primary')
