...
$query = "SELECT college_university, COUNT(*) as count 
          FROM educational_background 
          GROUP BY college_university 
          ORDER BY count DESC";
...
<div class="education-background-distribution-analytics">
    ...
    <div class="analytics-header">
        ...
        <h2 class="analytics-title">College/University Distribution Analysis</h2> <!-- Change title -->
    </div>
    ...
    <div class="analytics-content">
        <div class="analytics-chart-container">
            <canvas id="collegeUniversityDistribution"></canvas> <!-- Change canvas id -->
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function createChart(type) {
            const ctx = document.getElementById('collegeUniversityDistribution').getContext('2d'); // Change canvas id
            ...
            const config = {
                type: type,
                data: {
                    labels: <?php echo json_encode($labels); ?>, // College/University names
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        title: {
                            display: true,
                            text: 'Distribution by College/University', // Change title
                            font: {
                                size: 18
                            },
                            color: getComputedStyle(document.documentElement).getPropertyValue('--text-primary')
