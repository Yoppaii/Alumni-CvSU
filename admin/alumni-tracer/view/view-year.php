...
$query = "SELECT year_graduated, COUNT(*) as count 
...
<div class="education-background-distribution-analytics">
    <div class="analytics-header">
        ...
        <h2 class="analytics-title">Year Graduated Distribution Analysis</h2>
    </div>
    ...
    <div class="analytics-content">
        <div class="analytics-chart-container">
            <canvas id="yearGraduatedDistribution"></canvas>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function createChart(type) {
            const ctx = document.getElementById('yearGraduatedDistribution').getContext('2d');
            ...
            const config = {
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        title: {
                            display: true,
                            text: 'Distribution by Year Graduated',
                            font: {
                                size: 18
                            },
                            color: getComputedStyle(document.documentElement).getPropertyValue('--text-primary')
