...
<head>
    ...
    <style>
        ...
        .EV-modal-icon.success { background-color: var(--success-color); color: white; }
        .EV-modal-icon.error { background-color: var(--danger-color); color: white; }
        .EV-modal-icon.warning { background-color: var(--warning-color); color: white; }
...
function editEvent(id, day, month, title, venue, description) {
    ...
    document.querySelector('.EV-form').scrollIntoView({ behavior: 'smooth' });
}
