                        ...
                        <tr data-user-id="<?php echo htmlspecialchars($application['user_id']); ?>">
                            ...
                            <td>
                                ...
                                <td class="alm-hide-mobile">
                                    ...
                                    <?php elseif ($current_tab === 'confirmed'): ?>
                                        <div style="display: flex; gap: 0.5rem;">
                                            <select class="alm-status-select" data-application-id="<?php echo $application['id']; ?>" style="width: auto;">
                                                <option value="confirmed" <?php echo $application['status'] === 'confirmed' ? 'selected' : ''; ?>>Confirmed</option>
                                                <option value="paid">Paid</option>
                                            </select>
                                            <button class="alm-delete-btn" onclick="deleteApplication('<?php echo $application['id']; ?>', event)" style="width: auto;">
